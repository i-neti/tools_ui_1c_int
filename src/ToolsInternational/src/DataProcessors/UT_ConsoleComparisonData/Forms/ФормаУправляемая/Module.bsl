...
Процедура СравнитьДанныеНаСервере(СтруктураПараметровОтКлиента, ТекстОшибок)
	...
	Для СчетчикРеквизитов = 1 По ЧислоРеквизитов Цикл 
		Элементы["РезультатРеквизитА" + СчетчикРеквизитов].Title = ПредставленияЗаголовковРеквизитов["А" + СчетчикРеквизитов];
		Элементы["РезультатРеквизитБ" + СчетчикРеквизитов].Title = ПредставленияЗаголовковРеквизитов["Б" + СчетчикРеквизитов];
	КонецЦикла;
...
Процедура ОбновитьВидимостьДоступностьЭлементовФормы()
	...
	Элементы.РезультатКлюч2.Видимость = Объект.NumberColumnsInKey > 1;
	Элементы.РезультатКлюч3.Видимость = Объект.NumberColumnsInKey > 2;
	Элементы.РезультатТипСтолбца1Ключа.Видимость = Объект.DisplayKeyColumnTypes;
	Элементы.РезультатТипСтолбца2Ключа.Видимость = Объект.DisplayKeyColumnTypes И Объект.NumberColumnsInKey > 1;
	Элементы.РезультатТипСтолбца3Ключа.Видимость = Объект.DisplayKeyColumnTypes И Объект.NumberColumnsInKey > 2;
...
Процедура ОбновитьВидимостьДоступностьВкладкиУсловияВыводаСтрок()
	...
	Элементы.ГруппаУсловияВыводаСтрок.ЦветФона = ?(Объект.RowOutputConditionsDisabled, WebЦвета.Розовый, ЦветФонаФормыПоУмолчанию);;
...
Процедура ОбновитьВидимостьДоступностьВкладкиУсловияЗапретаВыводаСтрок()
	...
	Элементы.ГруппаУсловияЗапретаВыводаСтрок.ЦветФона = ?(Объект.ConditionsProhibitOutputRowsDisabled, WebЦвета.Розовый, ЦветФонаФормыПоУмолчанию);;
...
&НаКлиенте
Процедура RowOutputConditionsDisabledOnChange(Элемент)
