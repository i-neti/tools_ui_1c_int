...
Процедура СохранитьВСвязаннуюОперациюЗавершение(РезультатВопроса, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВопроса = КодВозвратаДиалога.Да Тогда
		...
		SaveSettingsToBaseAtServer(Объект.RelatedDataComparisonOperation, СохранятьТабличныеДокументы);
		ОбновитьЗаголовок();
...
&НаСервере
Процедура SaveSettingsToBaseAtServer(ВыбранныйЭлемент, СохранятьТабличныеДокументы = Ложь)
...
&НаСервере
Процедура OpenSettingsFromBaseAtServer(ВыбранныйЭлемент, ЗагружатьТабличныеДокументы = Ложь)
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ОперацияСравненияДанных") И ЗначениеЗаполнено(Параметры.ОперацияСравненияДанных) Тогда
		...
		ФормаОбъект = РеквизитФормыВЗначение("Объект");
		ФормаОбъект.OpenSettingsFromBaseAtServer(Объект.RelatedDataComparisonOperation);
		ЗначениеВРеквизитФормы(ФормаОбъект, "Объект");
