...
Процедура СравнитьДанныеНаСервере(СтруктураПараметровОтКлиента, ТекстОшибок)
	...
	Если Объект.BaseTypeA = 3 И Объект.ПодключениеКВнешнейБазеАУстройствоХраненияФайла = 1 Тогда
	...
	Если Объект.BaseTypeB = 3 И Объект.ПодключениеКВнешнейБазеБУстройствоХраненияФайла = 1 Тогда
		//Сохранение пути к исходному файлу
