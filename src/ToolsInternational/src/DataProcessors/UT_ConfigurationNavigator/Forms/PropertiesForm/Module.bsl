...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы._AccessRightForRole.Видимость = Ложь;
	Элементы.AccessRightToObject_Role.Видимость = Истина;

	Элементы.ValuePage.Видимость = Ложь;
	Элементы.DependentObjectsPage.Видимость = Ложь;
	Элементы.ManagingTotalsPage.Видимость = Ложь;
	...
	Если Параметры.FullName = "Конфигурация" Тогда
		...
		Элементы.StorageStructurePage.Видимость = Ложь;
		Перейти ~Завершение;
	КонецЕсли;
	...
	Элементы.AccessRightPage.Видимость = вЕстьПраваАдминистратора();
	Если Элементы.AccessRightPage.Видимость Тогда
	...
	ИначеЕсли Найти(Параметры.FullName, "Справочник.") = 1 Тогда
		...
		Элементы.DependentObjectsPage.Видимость = Истина;
	...
	ИначеЕсли Найти(Параметры.FullName, "Перечисление.") = 1 Тогда
		Элементы.AccessRightPage.Видимость = Ложь;
		_ListFormName = "";
	...
	ИначеЕсли Найти(Параметры.FullName, "Роль.") = 1 Тогда
		Если Не Элементы.AccessRightPage.Видимость Тогда
			Отказ = Истина;
			Возврат;
		КонецЕсли;
		...
		Элементы._AccessRightForRole.Видимость = Истина;
		Элементы.AccessRightToObject_Role.Видимость = Ложь;
		Элементы.PagesGroup.ТекущаяСтраница = Элементы.AccessRightPage;
...
Процедура вУстановитьУсловноеОформление()
	...
	ЭлементУО.Поля.Элементы.Добавить().Поле = Новый ПолеКомпоновкиДанных("_DependentObjectsName");
...
Процедура _ExpandAllNodes(Команда)
	Если Элементы.PagesGroup.ТекущаяСтраница = Элементы.ObjectPage Тогда
		...
		КонецЦикла;
	ИначеЕсли Элементы.PagesGroup.ТекущаяСтраница = Элементы.DependentObjectsPage Тогда
...
Процедура вЗаполнитьСраницуУправленияИтогами(FullName)
	...
	Элементы.ManagingTotalsPage.Видимость = Истина;
	...
	Элементы._RecalculateCurrentTotals.Доступность = пСтрук.ЕстьТекущиеИтоги И Не _AggregateMode;

	Элементы.RecalculateTotalsForPeriodGroup.Доступность = Не _AggregateMode;
	Элементы.CalculatedTotalsGroup.Доступность = Не пСтрук.ОборотныйРегистр И Не _AggregateMode;
...
Процедура _OpenAccessRightsObject(Команда)
	пИмяСтраницы = Элементы.AccessRightToObject.ТекущаяСтраница.Name;

	Если пИмяСтраницы = "AccessRightToObject_Role" Тогда
		ТекДанные = Элементы.RolesWithAccessTable.ТекущиеДанные;
		Если ТекДанные <> Неопределено Тогда
			вПоказатьСвойстваОбъекта("Роль." + ТекДанные.Name);
		КонецЕсли;

	ИначеЕсли пИмяСтраницы = "AccessRightToObject_Users" Тогда
	...
	ИначеЕсли пИмяСтраницы = "_AccessRightForRole" Тогда
